...
> **本栏实验样例**（端口约定：业务 `1808N`、pprof `1908N`，N 为篇章编号）：`code/architect/pprof-lab`（L01 CPU 热点 18081/19081、L02 分配与 GC 18082/19082、L03 goroutine 泄漏 18083/19083、L04 锁竞争 18084/19084、L05 channel 阻塞 18085/19085、L06 内存驻留 18086/19086、L07 IO 与序列化 18087/19087，另含自建压测器 `./cmd/load`）。开启了 `-fix` 即运行修复实现，用于 A/B 对比。
