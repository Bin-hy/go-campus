...
| 篇 | 内容 |
| --- | --- |
| [19 pprof 实战：从火焰图到架构决策](./19-pprof实战/) | **把「四个天花板」变成可复用的定位能力**：观测决策图、CPU 火焰图、内存与 GC、goroutine 与锁阻塞、27 条常见问题手册、生产环境安全采集、7 个完整案例、30 道面试题；配 8 个可跑实验（`code/architect/pprof-lab/`，零依赖、自带压测器，`-fix` 直接对比修复前后） |
