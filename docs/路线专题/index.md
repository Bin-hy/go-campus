...
> 四大板块并行推进：**算法专项训练**贯穿全周期；**后端与计算机基础夯实**（Day 1-7）、**大模型与 Agent 核心能力构建**（Day 8-17）、**简历项目改造与实战演练**（Day 18-30）三段主线接力。
...
flowchart TB
    ...
    subgraph 主线["三阶段主线"]
        B1["Day 1-7<br/>后端与计算机基础<br/>语言 / OS / 网络 / 存储"]
...
| [后端与计算机基础夯实（Day 1-7）](./02-后端与计算机基础) | Day 1-7 | Go/Python 并发、OS/网络、MySQL/Redis/MQ/向量库 | 计划「二」 |
...
| Day 7 | 链表综合 + LRU | 综合复习与自测（30 题） | 7 天复盘表 |
...
- **代码练习**：/练习指南、code/ 目录（Go 练习题）；Day 1-7 实战代码集见 `code/route/`（[习题集和答案/route](/习题集和答案/route/)）
