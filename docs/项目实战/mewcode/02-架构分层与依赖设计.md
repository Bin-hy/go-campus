...
**设计要点**：错误走 channel，接口无 error 返回值（详见 [§10 章](/项目实战/mewcode/10-多协议抽象与提示工程)）。
...
- [上一篇：项目全景与面试开场](/项目实战/mewcode/01-项目全景与面试开场)
- [下一篇：Agent 内核与 ReAct 循环](/项目实战/mewcode/03-Agent内核与ReAct循环)
