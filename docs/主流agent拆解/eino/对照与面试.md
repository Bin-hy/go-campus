...
- **自研印证**：你的 [agent-harness 项目](/项目实战/agent-harness/) 是手写版 Agent 运行时，Eino 是工业版——「我手写过一个简化版，再对照 Eino 理解了工业级设计的取舍」是极有说服力的叙事
